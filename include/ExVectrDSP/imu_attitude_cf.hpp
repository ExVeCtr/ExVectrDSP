...
namespace VCTR
{
    ...
    namespace DSP
    {
        ...
        protected:
            ...
            Core::Topic<Core::Timestamped<Math::Vector<float, 3>>> biasTopic_;
        ...
        public:
             ...
             */
            void setGyroInput(Core::Topic<Core::Timestamped<ValueCov<float, 3>>> &gyroTopic);
             ...
             */
            void setAccInput(Core::Topic<Core::Timestamped<ValueCov<float, 3>>> &accTopic);
             ...
             */
            Core::Topic<Core::Timestamped<Math::Vector<float, 3>>>& getBiasEstTopic();
