...
void IMUAttitudeEKF::updateGyro(
  ...
  x_[3][0] = quat[0][0] -
             dTimeHalf * (gyro[0][0] * quat[1][0] + gyro[1][0] * quat[2][0] +
                          gyro[2][0] * quat[3][0]);
  x_[4][0] = quat[1][0] +
             dTimeHalf * (gyro[0][0] * quat[0][0] - gyro[1][0] * quat[3][0] +
                          gyro[2][0] * quat[2][0]);
  x_[5][0] = quat[2][0] +
             dTimeHalf * (gyro[0][0] * quat[3][0] + gyro[1][0] * quat[0][0] -
                          gyro[2][0] * quat[1][0]);
  x_[6][0] = quat[3][0] -
             dTimeHalf * (gyro[0][0] * quat[2][0] - gyro[1][0] * quat[1][0] -
                          gyro[2][0] * quat[0][0]);
