...
ExVectrDSP offers data structures used by many systems and many types of data processing things like Kalman, Low-Pass filters etc.
## Dependencies:
...
- [X] Implement kalman filter based IMU, GNSS and Barometer Fusion.
- [ ] Implement FFT.
